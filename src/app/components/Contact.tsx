        ...
        <div className="my-20 ">
            ...
            <div className="flex flex-col">
                <div className="flex flex-col items-center mt-5 gap-2">
                    <Image src="/company-logos/email.png" alt="" className="w-12 aspect-1/1 grayscale"/>
                    <a href="mailto:alejandrofariaslozoya@gmail.com" className="text-md font-[FiraCode]">alejandrofariaslozoya@gmail.com</a>
                </div>

                <div className="flex flex-col items-center mt-5 gap-2">
                    <Image src="/company-logos/Linkedin-Icon.png" alt="" className="w-12 aspect-1/1 grayscale"/>
